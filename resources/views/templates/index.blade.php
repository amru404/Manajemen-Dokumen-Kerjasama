                            ...
                            <tr class="border-b border-gray-100 dark:border-white/[0.05]">
                                ...
                                <td class="px-4 sm:px-6 py-3.5">
                                    <div class="flex items-center gap-2">
                                        <a href="{{ route('templates.show', $t->id) }}" class="flex justify-center text-gray-700 cursor-pointer size-5 hover:text-indigo-500 dark:text-gray-400 dark:hover:text-indigo-400" title="Lihat detail">
                                        ...
                                        <a href="{{ route('templates.edit', $t->id) }}" class="flex justify-center text-gray-700 cursor-pointer size-5 hover:text-green-500 dark:text-gray-400 dark:hover:text-green-400" title="Edit Template">
                                            <svg class="inline h-7 w-7 flex justify-center" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <form action="{{ route('templates.destroy', $t->id) }}" method="POST" onsubmit="return confirm('Hapus template ini?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="flex justify-center text-gray-700 cursor-pointer size-5 hover:text-red-500 dark:text-gray-400 dark:hover:text-red-400" title="Hapus Template">
                                                <svg class="inline h-7 w-7 flex justify-center" fill="none" viewBox="0 0 24 24" stroke="currentColor">
