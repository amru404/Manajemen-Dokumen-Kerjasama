        ...
        <table class="min-w-full">
            <thead>
                <tr class="border-t border-gray-100 dark:border-gray-800">
                    ...
                    <th class="py-3 text-left">
                        <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Dibuat Oleh</p>
                    </th>
                    <th class="py-3 text-left">
            ...
            <tbody>
                @foreach($documentActivity as $document)
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <td class="py-3 whitespace-nowrap">
                          <p class="text-gray-500 text-theme-sm dark:text-gray-400">
                                @if(isset($document->created_at))
                                    {{ $document->created_at->format('H:i, d M Y') ?? 'N/A' }}
                                @else
                        ...
                        <td class="py-3 whitespace-nowrap">
                            <span class=" text-sm px-2 py-1 rounded text-xs font-semibold {{ $getStatusClassesActivity($document->activity_type ?? 'Aktif') }}">
        ...
        <table class="min-w-full">
            <thead>
                <tr class="border-t border-gray-100 dark:border-gray-800">
                    ...
                    <th class="py-3 text-left">
                        <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Tanggal Expired</p>
                    </th>
                    <th class="py-3 text-left">
                        <p class="font-medium text-gray-500 text-theme-xs dark:text-gray-400">Dibuat Oleh</p>
                    </th>
            ...
            <tbody>
                @foreach($akanExpired as $document)
                    <tr class="border-t border-gray-100 dark:border-gray-800">
                        ...
                        <td class="py-3 whitespace-nowrap">
                            <span class=" text-sm px-2 py-1 rounded text-xs font-semibold {{ $getStatusClasses($document->status ?? 'Aktif') }}">
