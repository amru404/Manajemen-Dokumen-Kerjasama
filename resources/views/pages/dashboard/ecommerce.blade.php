...
@section('content')
  <div class="grid grid-cols-12 gap-4 md:gap-12">
    ...
    <div class="col-span-12 xl:col-span-12">
      <x-ecommerce.recent-orders :documents="$documentActivity"/>
    ...
    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        ...
        <div class="flex items-center gap-3">
            <a href="{{ route('document-activities') }}" class="inline-flex items-center gap-2 rounded-lg border border-gray-300 bg-white px-4 py-2.5 text-theme-sm font-medium text-gray-700 shadow-theme-xs hover:bg-gray-50 hover:text-gray-800 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-white/[0.03] dark:hover:text-gray-200">
                See all
            </a>
        </div>
    </div>
    ...
    <div class="relative overflow-x-auto bg-neutral-primary-soft shadow-xs rounded-base border border-default">
        <table class="w-full min-w-max text-sm text-left text-body table-auto rounded-base">
            <thead class="text-sm text-body bg-neutral-secondary-soft border-b rounded-base border-default">
                <tr class="border-t border-gray-100 dark:border-gray-800">
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Judul Dokumen</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Tipe</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Mitra</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Waktu</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Dibuat Oleh</th>
                ...
                @foreach($documentActivity as $document)
                    <tr class="bg-neutral-primary border-b border-default">
                        <td class="px-6 py-4 whitespace-nowrap align-top">
                            <div class="flex items-center gap-3">
                                <div class="h-[40px] w-[40px] shrink-0 overflow-hidden rounded-md bg-gray-100 flex items-center justify-center">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap align-top text-gray-500 dark:text-gray-400">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap align-top">
                            <span class="inline-flex items-center justify-center rounded-full bg-gray-100 px-2 py-1 text-xs font-semibold text-gray-700 dark:bg-gray-800 dark:text-gray-300 {{ $getStatusClassesActivity($document->activity_type ?? 'Aktif') }}">
...
<div class="overflow-hidden mt-12 rounded-2xl border border-gray-200 bg-white px-4 pb-3 pt-4 dark:border-gray-800 dark:bg-white/[0.03] sm:px-6">
    <div class="flex flex-col gap-2 mb-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
        ...
        <table class="w-full min-w-max text-sm text-left text-body table-auto">
            <thead class="text-sm text-body bg-neutral-secondary-soft border-b rounded-base border-default">
                <tr class="border-t border-gray-100 dark:border-gray-800">
                    ...
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Tipe</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Mitra</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Tanggal Expired</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Dibuat Oleh</th>
                    <th class="px-6 py-3 font-medium whitespace-nowrap text-gray-500 dark:text-gray-400">Status</th>
                </tr>
            </thead>
            <tbody>
                @foreach($akanExpired as $document)
                    <tr class="bg-neutral-primary border-b border-default">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap align-top">
                            <span class="inline-flex items-center justify-center rounded-full bg-gray-100 px-2 py-1 text-xs font-semibold text-gray-700 dark:bg-gray-800 dark:text-gray-300 {{ $getStatusClasses($document->status ?? 'Aktif') }}">
