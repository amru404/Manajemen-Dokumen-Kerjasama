...
<aside id="sidebar"
    ...
    x-data="{
        ...
        isActive(path) {
            ...
            // support wildcard patterns ending with '*', e.g. '/mitra*'
            if (path.endsWith('*')) {
                                ...
                                <li>
                                            ...
                                            <span
                                                ...
                                                @if (!empty($item['new']))
                                                    <span class="absolute right-10"
                                                        :class="isActive('{{ $item['match'] ?? $item['path'] ?? '' }}') ?
                                    ...
                                    @else
                                        ...
                                        <a href="{{ $item['path'] }}" class="menu-item group"
                                            :class="[
                                                isActive('{{ $item['match'] ?? $item['path'] }}') ? 'menu-item-active' :
                                                'menu-item-inactive',
                                            ...
                                            <!-- Icon -->
                                            <span
                                                :class="isActive('{{ $item['match'] ?? $item['path'] }}') ? 'menu-item-icon-active' :
